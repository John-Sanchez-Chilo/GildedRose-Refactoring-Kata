...
class GildedRoseTest(unittest.TestCase):
    ...
    def test_class(self):
        items = [gr.NormalItem("foo", 0, 0),gr.Queso("Aged Brie",0,0),gr.Sulfuras("Sulfuras, Hand of Ragnaros",0,0),gr.EntradaAlBackstage("Backstage passes to a TAFKAL80ETC concert",0,0),gr.Conjured("Conjured",0,0)]
        ...
        self.assertEquals("Conjured", items[4].name)
